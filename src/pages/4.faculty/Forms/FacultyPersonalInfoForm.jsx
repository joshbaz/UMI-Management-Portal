...
const FacultyPersonalInfoForm = ({ handleNext, formRef }) => {
  ...
  const encryptedData = localStorage.getItem('facultyPersonalInfo')
  ...
  return (
    <Formik
      ...
      onSubmit={(values) => {
        ...
        localStorage.setItem('facultyPersonalInfo', encryptedValues)
        handleNext()
      }}
    >
...
export default FacultyPersonalInfoForm