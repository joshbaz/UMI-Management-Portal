...
const FacultyUserAccess = ({ formRef, createFacultyMutation }) => {
  ...
  const savedUserAccess = decryptData(localStorage.getItem('facultyUserAccess'))
  const personalInfo = decryptData(localStorage.getItem('facultyPersonalInfo') || '')
  ...
  return (
    <Formik
      ...
      onSubmit={(values) => {
        ...
        const personalInfo = decryptData(localStorage.getItem('facultyPersonalInfo') || '')
        const professionalInfo = decryptData(localStorage.getItem('facultyProfessionalSummary') || '')
        ...
        localStorage.setItem('facultyUserAccess', encryptData(values))
        
        // Store encrypted final data
        localStorage.setItem('facultyFinalData', encryptData(finalFormData))
        console.log('Final form data:', finalFormData)

        // Call mutation to create faculty
        createFacultyMutation.mutate(finalFormData);
      }}
    >
...
export default FacultyUserAccess