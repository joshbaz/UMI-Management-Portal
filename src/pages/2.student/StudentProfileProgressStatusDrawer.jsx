...
const StudentStatusDrawer = ({ isOpen, onClose, studentId, studentData, selectedStatus }) => {
  ...
  // Calculate total time in current status
  ...
  const data = {
    ...
    admissionDate: new Date(student?.createdAt).toLocaleDateString(),
                  ...
                  <div className="flex h-full flex-col">
                    ...
                    <div className="flex justify-center py-4 mt-3 mb-0">
                      <div className="flex justify-between items-center bg-white rounded-lg border p-4 w-[460px]">
                        <Dialog.Title className="text-base font-[Inter-Medium] text-gray-900 capitalize">
                         status Details
                        </Dialog.Title>
                        <button
                          onClick={onClose}
                      ...
                      <div className="flex flex-col items-center space-y-6 px-4 pb-6">
                        ...
                        <div className="flex justify-center">
                          <div className="flex justify-between items-start bg-transparent py-2  px-2 w-[460px]">
                            <div className="flex gap-3">
                              ...
                              <div>
                                <h3 className="text-gray-900 font-[Inter-Medium]">
                                  {data.name}
                                </h3>
                                <p className="text-gray-600 text-sm font-[Inter-Regular] capitalize">
                                  {data.type}
                                </p>
                              </div>
                            </div>
                            <div>
                              <p className="text-gray-600 text-sm font-[Inter-Regular]">
                                Student ID
                              </p>
                              <p className="text-gray-900 text-sm font-[Inter-Medium]">
                                {data.studentId}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="bg-tansparent rounded-lg  px-2 w-[460px]">
                            <div className="grid grid-cols-3 gap-4 place-items-center ">
                              ...
                              <div>
                                ...
                                <span className="text-gray-500 font-[Inter-Medium] text-sm">
                                  {data.totalTime}
                                </span>
                              </div>
                            </div>
                        ...
                        {/* <div className="flex justify-center">
                          <div className="bg-white rounded-lg border p-4 w-[460px]">
                            <h4 className="text-gray-900 font-[Inter-Medium] mb-4">
                              Timeline
                            </h4>
                            <div className="space-y-4">
                              <div className="flex items-start gap-3">
                                ...
                                <div>
                                  <p className="text-gray-900 font-[Inter-Medium]">
                                    Started Program
                                  </p>
                                  <p className="text-gray-500 font-[Inter-Regular] text-sm">
                                    {data.admissionDate}
                                  </p>
                                </div>
                              </div>
...
export default StudentStatusDrawer;
